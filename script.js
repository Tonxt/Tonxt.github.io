...
const t = {
  es: {
    ...
    "exp.item1.desc":  "Diseño y desarrollo de dos proyectos propios de punta a punta — un análisis exploratorio de datos y un pipeline automatizado — aplicando Python, Pandas, SQL y visualización de datos.",
    ...
    "proj.p2.desc":   "Pipeline de datos automatizado que monitorea 7 cotizaciones del dólar en Argentina (oficial, blue, MEP, CCL, cripto, mayorista y tarjeta): extracción diaria desde una API pública, almacenamiento en SQLite y análisis de tendencias con visualización.",
  ...
  en: {
    ...
    "exp.item1.desc":  "End-to-end design and development of two personal projects — an exploratory data analysis and an automated pipeline — applying Python, Pandas, SQL, and data visualization.",
    ...
    "proj.p2.badge":  "Done",
    "proj.p2.desc":   "Automated data pipeline that monitors 7 USD exchange rates in Argentina (official, blue, MEP, CCL, crypto, wholesale, and card): daily extraction from a public API, SQLite storage, and trend analysis with visualization.",
